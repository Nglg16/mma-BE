...
exports.createService = async (req, res) => {
    try {
        ...
        const newService = new Service({ name, description, price, duration, category, status });
...
exports.updateService = async (req, res) => {
    try {
        ...
        const updatedService = await Service.findByIdAndUpdate(id, updatedData, { new: true, runValidators: true });
